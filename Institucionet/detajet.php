...
{	
    ...
    || empty($fjalekalimi)) {	
		...
		mysqli_query($conn22, "SET @p_id_p_dip=${id_p_dip}");
		mysqli_query($conn22, "SET @p_emri='${emri}'");
		mysqli_query($conn22, "SET @p_mbiemri='${mbiemri}'");
		mysqli_query($conn22, "SET @p_nr_personal='${nr_personal}'");
		mysqli_query($conn22, "SET @p_datelindja='${datelindja}'");
        mysqli_query($conn22, "SET @p_telefoni='${telefoni}'");
		mysqli_query($conn22, "SET @p_emaili='${emaili}'");
        mysqli_query($conn22, "SET @p_fjalekalimi='${fjalekalimi}'");
		mysqli_query($conn22, "SET @p_file='${imgData}'");
        mysqli_query($conn22, "SET @p_name='${name}'");
		$result=mysqli_query($conn22,"CALL modifikoProfilin(@p_id_p_dip,@p_emri,@p_mbiemri,@p_nr_personal,
...
$result = mysqli_query($conn22,"CALL zgjedhDiplomen_Raporti('$id_p_dip')");
					...
					<section id="four" class="wrapper alt style1">
							...
							<div class="inner">
                                <h3 class="major">Diplomat</h3>
										<?php
																	$result = mysqli_query($conn23, "CALL zgjedh_leftouterjoin_Raporti('$id_p_dip')");
