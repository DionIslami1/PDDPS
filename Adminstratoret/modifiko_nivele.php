						...
						<section id="four" class="wrapper alt style1">
							...
							<div class="table-wraper" style="border-top: 10%" >
                                <form action="" method="post">
									<table>
										<tr>
											<h2>Kërko të dhënat e Niveleve për modifikim ose fshirje</h2>
										</tr>
										<tr>
											<td> 
												Shkruaj:
											...
											<td>
												<input type="text" name="term" placeholder="Nivelin"/>
											</td>
									...
									<table style="width: 100%; white-space: nowrap;">
										...
										<?php
											if (!empty($_REQUEST['term'])) {
												...
												($conn,$_REQUEST['term']);
												$sql= mysqli_query ($conn31, "CALL zgjedhTermNivelin('$term')"); 
											while($row = mysqli_fetch_array($sql)) { 		
													echo "<tr>";
													echo "<td>".$row['niveli']."</td>";		
													echo "<td><a href=\"updateNivelin.php?id_niveli=$row[id_niveli]\" class='button primary'>
													Modifiko</a></td>";
													echo "<td><a href=\"fshiNivele.php?id_niveli=$row[id_niveli]
													\" onClick=\"return confirm('A jeni të sigurt së dëshironi të fshini Nivelin?')\" 
