...
<html>
	<head>
		<title>Profilet e të Diploamuarve</title>
		<meta charset="utf-8" />
						...
						<section id="four" class="wrapper alt style1">
							...
							<div class="table-wraper" style="border-top: 10%" >
                                <form action="" method="post">
									<table>
										<tr>
											<h2>Kërko të dhënat e të Diplomuarve për shikim ose fshirje</h2>
										</tr>
										<tr>
											<td> 
												Shkruaj:
									...
									<table style="width: 100%; white-space: nowrap;">
										...
										<?php
											if (!empty($_REQUEST['term'])) {
												...
												($conn,$_REQUEST['term']);     
												$sql= mysqli_query ($conn31, "CALL zgjedhTermTeDiplomuarit('$term')"); 
											while($row = mysqli_fetch_array($sql)) { 		
													...
													echo "<td>".$row['name']."</td>";	
													echo "<td><a href=\"listaDiplomave.php?id_p_dip=$row[id_p_dip]\" class='button primary'>
													Shiko Diplomat</a></td>";
