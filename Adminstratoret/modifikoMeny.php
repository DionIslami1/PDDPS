						...
						<section id="four" class="wrapper alt style1">
							...
							<div class="table-wraper" style="border-top: 10%" >
                                <form action="" method="post">
									<table>
										<tr>
											<h2>Kërko të dhënat e Menyve për modifikim</h2>
										</tr>
										<tr>
											<td> 
												Shkruaj:
											...
											<td>
												<input type="text" name="term" placeholder="Emrin ose Modulin"/>
											</td>
									...
									<table style="width: 100%; white-space: nowrap;">
										...
										<?php
											if (!empty($_REQUEST['term'])) {
												...
												($conn,$_REQUEST['term']);     
												$sql= mysqli_query ($conn32, "CALL zgjedhTermMenyte('$term')"); 
											while($row = mysqli_fetch_array($sql)) { 		
													echo "<tr>";
													echo "<td>".$row['Emri']."</td>";	
													echo "<td>".$row['Modul']."</td>";	
													echo "<td><a href=\"updateMenyte.php?id_m=$row[id_m]\" class='button primary'>
													Modifiko</a></td></tr>";	
												}
											}
											?>           
