						...
						<section id="four" class="wrapper alt style1">
							...
							<div class="table-wraper" style="border-top: 10%" >
                                <form action="" method="post">
									<table>
										<tr>
											<h2>Kërko të dhënat modifikim </h2>
										</tr>
										<tr>
											<td> 
												Shkruaj:
											...
											<td>
												<input type="text" name="term" placeholder="Pamjafaqës"/>
											</td>
							...
							<div class="table-wrapper" style="overflow-x:auto; width: 100%;">
									<table style="width: 100%; white-space: nowrap;">
										<tr>
											<td><b>Titulli</b></td>
											<td><b>Përshkrimi</b></td>
											<td><b>Pamjafaqës</b></td>
											<td><b>Modifiko</b></td>
										</tr>
										<?php
											if (!empty($_REQUEST['term'])) {
												...
												($conn,$_REQUEST['term']);     
												$sql= mysqli_query ($conn32, "CALL zgjedhTermTedhenat('$term')"); 
											while($row = mysqli_fetch_array($sql)) { 		
													echo "<tr>";
													echo "<td>".$row['emertimi']."</td>";	
													echo "<td>".$row['pershkrimi']."</td>";	
													echo "<td>".$row['pamjafaqes']."</td>";
													echo "<td><a href=\"update_tedhenat.php?id_tedhenat=$row[id_tedhenat]\" class='button primary'>
													Modifiko</a></td></tr>";	
												}
											}
											?>           
