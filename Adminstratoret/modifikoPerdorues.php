						...
						<section id="four" class="wrapper alt style1">
							...
							<div class="table-wraper" style="border-top: 10%" >
                                <form action="" method="post">
									<table>
										<tr>
											<h2>Kërko të dhënat e Përdoruesve për modifikim ose fshirje</h2>
										</tr>
										<tr>
											<td> 
												Shkruaj:
											...
											<td>
												<input type="text" name="term" placeholder="Emrin ose Email-in"/>
											</td>
									...
									<table style="width: 100%; white-space: nowrap;">
										...
										<?php
											if (!empty($_REQUEST['term'])) {
												...
												($conn,$_REQUEST['term']);     
												$sql= mysqli_query ($conn31, "CALL zgjedhTermPerdorues('$term')"); 
											while($row = mysqli_fetch_array($sql)) { 		
													...
													echo "<td><a href=\"updatePerdorues.php?id_p_adm=$row[id_p_adm]\" class='button primary'>
													Modifiko</a></td>";
													echo "<td><a href=\"fshiPerdorues.php?id_p_adm=$row[id_p_adm]
													\" onClick=\"return confirm('A jeni të sigurt së dëshironi të fshini Përdoruesin?')\" 
